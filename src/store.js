    ...
    getProjectData(state, data) {
      ...
      let projects = [
...

        {
          ...
          about: "I made this site because im a big fan of the supernatural series and thought it would be good to get some information on what the\
...

        {
          ...
          link: 'https://play.google.com/store/apps/details?id=io.syntappz.fusion&gl=GB',
